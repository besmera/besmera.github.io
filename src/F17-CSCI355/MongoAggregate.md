...
# Restricting Access to Documents and Fields
...
```
 ...
 <img class="fragment fade-in" data-fragment-index="0" height="540px" src="aggregate_let.png" alt="Aggregate Let Example" style="position:absolute;top:0;left:0;" />
</div>

## $map

* Lets you apply an expression to values in arrays
```JSON
{ 
	$map: 
		{ 
...
## Subexpression Calculations on Arrays
...
```
 ...
 <img class="fragment fade-in" data-fragment-index="0" height="540px" src="aggregate_map.png" alt="Aggregate Map Example" style="position:absolute;top:0;left:0;" />
</div>
